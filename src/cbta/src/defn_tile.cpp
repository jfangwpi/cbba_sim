...
void Tile::setMatricesFromJSON(std::string traversal_type_str,
	...
	this->cell_xform = Matrix<int,Eigen::Dynamic,2>::Zero(counter,n);
	test_str.clear();
	...
	this->channel_data = Matrix<int,Eigen::Dynamic,4>::Zero(counter,n);
	test_str.clear();
	...
	ss >> test_str;
	n = std::count(test_str.begin(), test_str.end(), ',');
	this->traversal_faces = Matrix<int,Eigen::Dynamic,1>::Zero(counter,n);
	test_str.clear();
	...
	ss >> test_str;
	n = std::count(test_str.begin(), test_str.end(), ',');
	this->traversal_type = Matrix<int,Eigen::Dynamic,1>::Zero(counter,n);
	test_str.clear();
	...
	this->cell_edge = Matrix<double,Eigen::Dynamic,4>::Zero(counter,n);
	test_str.clear();
	...
	ss >> test_str;
	n = std::count(test_str.begin(), test_str.end(), ',');
	this->cell_vertices = Matrix4Xd::Zero(counter,n);
	test_str.clear();
	ss.clear();
